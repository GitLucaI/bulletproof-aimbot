...
b.Position = pos
b.Text = txt
b.BackgroundColor3 = startS and _S._V._s or _S._V._ac
b.TextColor3 = Color3.new(1, 1, 1)
b.Font = Enum.Font.Code
b.TextSize = 10
_rnd(b, 6)
...
_bldB("HEAD", UDim2.new(0,0,0,0), nil, function() _S._P = "Head" end, nil, false, _S._P == "Head")
_bldB("TORSO", UDim2.new(0.34,0,0,0), nil, function() _S._P = "UpperTorso" end, nil, false, _S._P == "UpperTorso")
_bldB("LEGS", UDim2.new(0.68,0,0,0), nil, function() _S._P = "LeftLowerLeg" end, nil, false, _S._P == "LeftLowerLeg")
...
_bldB("OPPOSING TEAM", UDim2.new(0,0,0,72), UDim2.new(1,0,0,30), function(b) _S._OpM = not _S._OpM; b.BackgroundColor3 = _S._OpM and _S._V._s or _S._V._u; _updOpponents() end, nil, false, _S._OpM)
